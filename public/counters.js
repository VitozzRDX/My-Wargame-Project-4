...
class ManCounters extends SelfMovingCounters {
    ...
    getCoverArc() {
        //console.log('returning CA inside MC class')
        let list = [];

        list.push({q: 1 + this.ownHex.q, r: this.ownHex.r, s: -1+this.ownHex.s});
        list.push({ q:this.ownHex.q, r: 1 + this.ownHex.r, s: -1 + this.ownHex.s });
        list.push({ q: -1 + this.ownHex.q, r: 1 + this.ownHex.r, s:  this.ownHex.s });
        list.push({ q: -1 + this.ownHex.q, r:this.ownHex.r, s: 1 + this.ownHex.s });
        list.push({ q: this.ownHex.q, r:-1 + this.ownHex.r, s: 1 + this.ownHex.s });
        list.push({ q: 1 + this.ownHex.q, r: -1 + this.ownHex.r, s: this.ownHex.s });
